...
#define   PDFLIB_PECL_VERSIONSTRING "2.1.5"
...
/* {{{ proto bool pdf_add_launchlink(resource p, double llx, double lly,
...
/* {{{ proto bool pdf_add_locallink(resource p, double llx, double lly,
 * double urx, double ury, int page, string optlist)
 * Deprecated, use PDF_create_action() and PDF_create_annotation(). */
...
/* {{{ proto bool pdf_add_note(resource p, double llx, double lly, double urx,
 * double ury, string contents, string title, string icon, int open)
...
/* {{{ proto bool pdf_add_pdflink(resource p, double llx, double lly,
 * double urx, double ury, string filename, int page, string optlist)
 * Deprecated, use PDF_create_action() and PDF_create_annotation(). */
...
/* {{{ proto bool pdf_add_weblink(resource p, double llx, double lly,
 * double urx, double ury, string url)
 * Deprecated, use PDF_create_action() and PDF_create_annotation(). */
...
/* {{{ proto bool pdf_arc(resource p, double x, double y, double r,
...
/* {{{ proto bool pdf_arcn(resource p, double x, double y, double r,
 * double alpha, double beta);
...
/* {{{ proto bool pdf_attach_file(resource p, double lly, double lly,
 * double urx, double ury, string filename, string description,
...
/* {{{ proto bool pdf_begin_glyph(resource p, string glyphname, double wx,
...
/* {{{ proto bool pdf_begin_page_ext(resource p, double width, double height,
 * string optlist)
...
/* {{{ proto int pdf_begin_pattern(resource p, double width, double height,
...
PHP_FUNCTION(pdf_begin_pattern)
{
    ...
    pdf_try {
        retval = PDF_begin_pattern(pdf, width, height, xstep, ystep,
            (int)painttype);
    } pdf_catch;
...
/* {{{ proto bool pdf_concat(resource p, double a, double b, double c,
...
/* {{{ proto bool pdf_create_annotation(resource p, double llx, double lly,
 * double urx, double ury, string type, string optlist)
...
/* {{{ proto bool pdf_create_field(resource p, double llx, double lly,
 * double urx, double ury, string name, string type, string optlist)
...
/* {{{ proto bool pdf_create_fieldgroup(resource p, string name,
 * string optlist);
...
/* {{{ proto bool pdf_create_pvf(resource p, string filename, string data,
 * string optlist);
...
/* {{{ proto bool pdf_curveto(resource p, double x1, double y1, double x2,
...
/* {{{ proto bool pdf_encoding_set_char(resource p, string encoding, int slot,
string glyphname, int uv);
...
/* {{{ proto int pdf_fill_imageblock(resource p, int page, string blockname,
int image, string optlist);
...
PHP_FUNCTION(pdf_fill_imageblock)
{
    ...
    pdf_try {
        retval = PDF_fill_imageblock(pdf, (int)page, blockname, (int)image,
            optlist);
    } pdf_catch;
...
/* {{{ proto int pdf_fill_pdfblock(resource p, int page, string blockname,
int contents, string optlist);
...
PHP_FUNCTION(pdf_fill_pdfblock)
{
    ...
    pdf_try {
        retval = PDF_fill_pdfblock(pdf, (int)page, blockname, (int)contents,
            optlist);
    } pdf_catch;
...
/* {{{ proto int pdf_fill_textblock(resource p, int page, string spotname,
...
PHP_FUNCTION(pdf_fill_textblock)
{
    ...
    pdf_try {
        retval = PDF_fill_textblock(pdf, (int)page, blockname, text, tlen,
        optlist);
    } pdf_catch;
...
/* {{{ proto int pdf_findfont(resource p, string fontname, string encoding,
int embed)
...
/* {{{ proto bool pdf_fit_image(resource p, int image, double x, double y,
string optlist);
...
/* {{{ proto bool pdf_fit_pdi_page(resource p, int page, double x, double y,
string optlist);
...
/* {{{ proto string pdf_fit_textflow(resource p, int textflow, double llx,
double lly, double urx, double ury, string optlist)
...
PHP_FUNCTION(pdf_fit_textflow)
{
    ...
    pdf_try {
        retbuf = PDF_fit_textflow(pdf, (int)textflow, llx, lly, urx, ury,
        optlist);
    } pdf_catch;
...
/* {{{ proto bool pdf_fit_textline(resource p, string text, double x,
 * double y, string optlist);
...
/* {{{ proto string pdf_get_pdi_parameter(resource p, string key, int doc,
int page, int reserved);
...
PHP_FUNCTION(pdf_get_pdi_parameter)
{
    ...
    pdf_try {
        retbuf = PDF_get_pdi_parameter(pdf, key, (int)doc, (int)page,
            (int)reserved, &size);
    } pdf_catch;
...
/* {{{ proto double pdf_get_pdi_value(resource p, string key, int doc,
int page, int reserved);
...
/* {{{ proto int pdf_load_font(resource p, string fontname, string encoding,
string optlist);
...
/* {{{ proto int pdf_load_iccprofile(resource p, string profilename,
string optlist);
...
/* {{{ proto int pdf_load_image(resource p, string imagetype,
...
/* {{{ proto int pdf_open_ccitt(resource p, string filename, int width,
int height, int bitreverse, int k, int blackls1)
...
string data, long length, int width, int height, int components, int bpc,
string params)
...
/* {{{ proto int pdf_open_image_file(resource p, string imagetype,
string filename, string stringparam, int intparam)
 * Deprecated, use PDF_load_image(). */
...
/* {{{ proto int pdf_open_pdi_page(resource p, int doc, int pagenumber,
string optlist);
...
/* {{{ proto bool pdf_place_image(resource p, int image, double x, double y,
double scale)
...
/* {{{ proto bool pdf_place_pdi_page(resource p, int page, double x, double y,
double sx, double sy)
...
/* {{{ proto bool pdf_rect(resource p, double x, double y, double width,
double height)
 * Draw a rectangle. */
...
/* {{{ proto bool pdf_set_border_color(resource p, double red, double green,
double blue)
...
/* {{{ proto bool pdf_set_layer_dependency(resource p, string type,
string optlist);
...
/* {{{ proto bool pdf_setcolor(resource p, string fstype, string colorspace,
...
/* {{{ proto bool pdf_setmatrix(resource p, double a, double b, double c,
double d, double e, double f)
...
PHP_FUNCTION(pdf_setpolydash)
{
    ...
    for (i=0; i<len; i++) {
        ...
        if (Z_TYPE_P(keydata) == IS_DOUBLE) {
            ...
            _pdf_exception(99, "PDF_set_polydash", "illegal darray value"
                TSRMLS_CC);
        }
...
/* {{{ proto int pdf_shading(resource p, string type, double x0, double y0,
double x1, double y1, double c1, double c2, double c3, double c4,
string optlist);
...
/* {{{ proto int pdf_show_boxed(resource p, string text, double left,
double top, double width, double height, string hmode, string feature])
...
/* {{{ proto double pdf_stringwidth(resource p, string text, int font,
double fontsize)
...
PHP_FUNCTION(pdf_open_memory_image)
{
    ...
    if (ZEND_NUM_ARGS() != 2 || zend_get_parameters_ex(2, &p, &image)
            == FAILURE) {
        WRONG_PARAM_COUNT;
    }
...
#if defined(PHP_MAJOR_VERSION) /* PHP 4.3.0 or newer */
        php_error_docref(NULL TSRMLS_CC, E_ERROR,
        "Unable to find handle for GD image stream. "
        "Please check the GD extension is loaded.");
#else
        php_error(E_ERROR, "Unable to find handle for GD image stream. "
        "Please check the GD extension is loaded.");
#endif
    }
